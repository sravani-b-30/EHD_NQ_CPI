...
def run_analysis_button(merged_data_df, asin, price_min, price_max, target_price, same_brand_option, compulsory_features):
    # Set recompute flag
...
if st.button("Analyze"):
    run_analysis_button(merged_data_df, asin, price_min, price_max, target_price, same_brand_option, compulsory_features)
